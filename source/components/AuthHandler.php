            ...
            if ($auth) { // login
                ...
                if ($email !== null && User::find()->where(['email' => $email])->exists()) {
                    ...
                    $user = new User([
                        ...
                        'password_reset_token' => 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
                        'status' => 1,
                    ...
                    if ($user->save()) {
                        ...
                        if ($auth->save() && $profile->save()) {
                            ...
                            Yii::$app->getSession()->setFlash('error', [
                                Yii::t('app', 'Unable to save {client} account: {errors}', [
                                    'client' => $this->client->getTitle(),
                                    'errors' => json_encode($profile->getErrors()),
                                ]),
                            ]);
                        }
                    } else {
